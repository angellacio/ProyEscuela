...
namespace Electronica_AccesoBD
{
    public class manejoSeguridad
    {
        ...
        public ent.entSeguridad validaCredenciales(string sUsuario, string sContraseña)
        {
            ...
            {
                //ManejoLogErrores.txt_mensajeError(ex.ToString());
                throw new Exception("Error en la autentificación.", ex);
            }
            finally
            {
                if (sqlDR != null)
        ...
        public List<ent.entSeguridad> ReservaArchivosProcesar(int? nIdUsuario, string sUsuario, string sApellido1, string sApellido2, string sNombre, Boolean? bolEstado)
        {
