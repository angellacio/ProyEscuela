...
namespace Aplicacion_Electronica.Formas
{
    public partial class frmSeguridad_Busqueda : Form
    {
        ...
        {
            Electronica_AccesoBD.manejoSeguridad DatosSeguridad = null;
            List<Electronica_Entidades.entSeguridad> lstClientes = null;
            try
            {
                DatosSeguridad = new Electronica_AccesoBD.manejoSeguridad();

                lstClientes = DatosSeguridad.ReservaArchivosProcesar(nIDUsuario, sUsuario, sApellido1, sApellido2, sNombre, bolEstado);
